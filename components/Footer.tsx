...
// Official brand glyphs (Simple Icons, 24x24, single path, currentColor).
const socials = [
  {
  ...
  {
    href: "https://www.threads.com/@lumi.estate",
    label: "Threads",
  ...
  {
    href: "https://www.youtube.com/channel/UCadfvItsmAONupSndLET6WQ",
    label: "YouTube",
              ...
              <div className="flex items-center gap-3">
                {socials.map((s) => (
                  <a
                    ...
                    aria-label={`Lumi on ${s.label}`}
                    title={s.label}
                    className="w-9 h-9 rounded-btn border border-border flex items-center justify-center text-text-dim hover:text-white hover:bg-accent hover:border-accent transition-colors"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      width="18"
